...
const City = ({cityName,high,low,weather}) => {
  ...
  const mist = <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-cloud-fog2 icon" viewBox="0 0 16 16">
  ...
  const clouds = <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="currentColor" class="bi bi-clouds icon" viewBox="0 0 16 16">
